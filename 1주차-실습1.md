...
## 전체코드
[1주차-실습1_전체코드.cpp](https://github.com/moduPlayGround/ComputerVision-for-VisualRecognition/blob/master/1%EC%A3%BC%EC%B0%A8-%EC%8B%A4%EC%8A%B5/Example_001(webcam).cpp)<br>
[1주차-실습1_전체코드(웹캠이 없으신 분)](https://github.com/moduPlayGround/ComputerVision-for-VisualRecognition/blob/master/1%EC%A3%BC%EC%B0%A8-%EC%8B%A4%EC%8A%B5/Example_001(images).cpp)
...
```
만약 이해가 어려워서 카메라를 이용하지 않은 2개의 이미지끼리의 매칭코드를 보고 싶으시다면
[1주차-실습1_이미지를 이용한 물체인식](https://github.com/moduPlayGround/ComputerVision-for-VisualRecognition/blob/master/1%EC%A3%BC%EC%B0%A8-%EC%8B%A4%EC%8A%B5/Example_001(images).cpp)를 참고해 주세요 <br>
