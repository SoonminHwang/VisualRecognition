...
## 본 파일 실행을 위해 [data2의 MNIST.zip](https://github.com/moduPlayGround/ComputerVision-for-VisualRecognition/blob/master/2%EC%A3%BC%EC%B0%A8-%EC%8B%A4%EC%8A%B5/data2/MNIST.zip)의 압축을 풀어야하며, MNIST_CNN_SVM_linear_acc94.5.xml,MNIST_HOG_SVM_Linear_acc97.xml 와 CNN_train_rs.csv 를 받으셔야합니다. 해당파일은 모두 data1 폴더에 첨부해주시길 바랍니다.
